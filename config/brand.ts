...
export const BRAND: BrandConfig = {
  businessName: "Silpi Jewellers",
  tagline: "Fine Jewellery in Chalakudy",
  description:
    "Silpi Jewellers is Chalakudy's trusted destination for exquisite gold, diamond, and silver jewellery. Serving Chalakudy and the surrounding areas with timeless craftsmanship and contemporary designs for every celebration.",
  ...
  address: "North Junction, North Chalakudy, Chalakudy, Kerala 680307",
  city: "Chalakudy",
  state: "Kerala",
  pincode: "680307",

  phone: "+919562207777",
  whatsapp: "919562207777",
  email: "",

  mapsLink:
    "https://www.google.com/maps/search/?api=1&query=Silpi%20Jewellers&query_place_id=ChIJXdgYidQDCDsR5lO4QvLb2hQ",
  ...
  seo: {
    title: "Silpi Jewellers | Jewellery in Chalakudy",
    description:
      "Silpi Jewellers — your premier jewellery store in Chalakudy. Gold, diamond and silver jewellery crafted for every occasion. Visit us in Chalakudy, Kerala.",
    keywords: [
      "Silpi Jewellers",
      "jewellery Chalakudy",
    ...
    canonical: "https://silpi-jewellers-north-chalakudy.vercel.app",
    ogImage:
      "/images/store1.webp",
  },
  ...
  whatsappMessage:
    "Hello Silpi Jewellers, I'd like to know more about your jewellery collections.",
};
